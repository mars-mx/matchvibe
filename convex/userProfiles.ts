...
export const upsertProfile = mutation({
  args: {
    ...
    intellectualRating: v.optional(v.number()), // renamed from qualityRating
    positivityRating: v.optional(v.number()),
    empathyRating: v.optional(v.number()),
    engagementRating: v.optional(v.number()),
    debateRating: v.optional(v.number()),
    politicalRating: v.optional(v.number()),
    personalSharingRating: v.optional(v.number()),
    inspirationalQuotesRating: v.optional(v.number()),
    extroversionRating: v.optional(v.number()),
    authenticityRating: v.optional(v.number()),
    optimismRating: v.optional(v.number()),
    humorRating: v.optional(v.number()),
    aiGeneratedRating: v.optional(v.number()),
